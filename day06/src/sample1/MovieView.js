...
const MovieView = ({movie , onOpen }) => {
    const {thumbUrl ,movieNm,openDt,moviePrdtStat,movieType,watchGradeNm,showTs,repNationCd,director,genre,dtNm } = movie
    return (
        <div className="view" onClick={ onOpen }>
            ...
            <div>
                <h3>{movieNm}</h3>
                <ul>
                    <li> <em>개봉일</em> : {moment(openDt).format('YYYY-MM-DD')}</li>
